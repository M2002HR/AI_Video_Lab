...
اجرای قابل‌تکرار STAGE_05 با حفظ evidence و gate روشن.

## ورودی لازم

اصل‌ها و رفرنس تولیدی. ورودی اختیاری: feedback کاربر، reference style/scene و constraint ابزار. پیش‌نیاز: stage قبلی approved یا blocker/assumption ثبت‌شده.

## رویه

1. STATUS، SOP/checklist و evidence مرتبط را بخوانید.
2. geometry/color/material/label را با اصل مقایسه و drift را رد کن.
...
approved reference set. Pass یعنی usable، provenance کامل و معیار stage؛ Fail یعنی blocker/failure و تصمیم repair/regenerate/بازگشت ثبت شده.
