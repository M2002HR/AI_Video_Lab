...
اجرای قابل‌تکرار STAGE_02 با حفظ evidence و gate روشن.

## ورودی لازم

تصاویر محصول. ورودی اختیاری: feedback کاربر، reference style/scene و constraint ابزار. پیش‌نیاز: stage قبلی approved یا blocker/assumption ثبت‌شده.

## رویه

1. STATUS، SOP/checklist و evidence مرتبط را بخوانید.
2. silhouette، نسبت‌ها، material، texture، رنگ، packaging و forbidden transformations را ثبت کن.
...
identity spec، identity lock، uncertainty. Pass یعنی usable، provenance کامل و معیار stage؛ Fail یعنی blocker/failure و تصمیم repair/regenerate/بازگشت ثبت شده.
