# SOP 01 SOURCE PROMPT ANALYSIS

## هدف

اجرای قابل‌تکرار STAGE_01 با حفظ evidence و gate روشن.

## ورودی لازم

پرامپت immutable و brief. ورودی اختیاری: feedback کاربر، reference style/scene و constraint ابزار. پیش‌نیاز: stage قبلی approved یا blocker/assumption ثبت‌شده.

## رویه

1. STATUS، SOP/checklist و evidence مرتبط را بخوانید.
2. DNA ساختاری، محتوای محصول قدیمی، مفهوم reusable و contradictionها را جدا کن.
...
تحلیل KEEP/ADAPT/REMOVE و risk. Pass یعنی usable، provenance کامل و معیار stage؛ Fail یعنی blocker/failure و تصمیم repair/regenerate/بازگشت ثبت شده.
