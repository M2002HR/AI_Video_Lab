...
اجرای قابل‌تکرار STAGE_04 با حفظ evidence و gate روشن.

## ورودی لازم

reference plan. ورودی اختیاری: feedback کاربر، reference style/scene و constraint ابزار. پیش‌نیاز: stage قبلی approved یا blocker/assumption ثبت‌شده.

## رویه

1. STATUS، SOP/checklist و evidence مرتبط را بخوانید.
2. هر رفرنس تولیدی Run مستقل و QA دارد؛ اصل را جایگزین نکن.
...
Runهای reference. Pass یعنی usable، provenance کامل و معیار stage؛ Fail یعنی blocker/failure و تصمیم repair/regenerate/بازگشت ثبت شده.
