...
اجرای قابل‌تکرار STAGE_08 با حفظ evidence و gate روشن.

## ورودی لازم

candidate و rubric. ورودی اختیاری: feedback کاربر، reference style/scene و constraint ابزار. پیش‌نیاز: stage قبلی approved یا blocker/assumption ثبت‌شده.

## رویه

1. STATUS، SOP/checklist و evidence مرتبط را بخوانید.
2. focus، feasibility، complexity و hero را امتیازدهی و انتخاب را ثبت کن.
...
scenario selected و decision. Pass یعنی usable، provenance کامل و معیار stage؛ Fail یعنی blocker/failure و تصمیم repair/regenerate/بازگشت ثبت شده.
