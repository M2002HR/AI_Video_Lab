...
اجرای قابل‌تکرار STAGE_17 با حفظ evidence و gate روشن.

## ورودی لازم

video Run. ورودی اختیاری: feedback کاربر، reference style/scene و constraint ابزار. پیش‌نیاز: stage قبلی approved یا blocker/assumption ثبت‌شده.

## رویه

1. STATUS، SOP/checklist و evidence مرتبط را بخوانید.
2. identity، morph، count، contact، gravity، camera، lighting و hero را نمره بده.
...
frame-by-frame evaluation. Pass یعنی usable، provenance کامل و معیار stage؛ Fail یعنی blocker/failure و تصمیم repair/regenerate/بازگشت ثبت شده.
