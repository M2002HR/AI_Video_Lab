...
اجرای قابل‌تکرار STAGE_15 با حفظ evidence و gate روشن.

## ورودی لازم

package. ورودی اختیاری: feedback کاربر، reference style/scene و constraint ابزار. پیش‌نیاز: stage قبلی approved یا blocker/assumption ثبت‌شده.

## رویه

1. STATUS، SOP/checklist و evidence مرتبط را بخوانید.
2. contradiction، complexity، role رفرنس، timing، camera و known failure را چک کن.
...
preflight report. Pass یعنی usable، provenance کامل و معیار stage؛ Fail یعنی blocker/failure و تصمیم repair/regenerate/بازگشت ثبت شده.
