...
اجرای قابل‌تکرار STAGE_20 با حفظ evidence و gate روشن.

## ورودی لازم

final candidate. ورودی اختیاری: feedback کاربر، reference style/scene و constraint ابزار. پیش‌نیاز: stage قبلی approved یا blocker/assumption ثبت‌شده.

## رویه

1. STATUS، SOP/checklist و evidence مرتبط را بخوانید.
2. trim، color، text/logo overlay، audio و delivery format را traceable ثبت کن.
...
edit/composite record. Pass یعنی usable، provenance کامل و معیار stage؛ Fail یعنی blocker/failure و تصمیم repair/regenerate/بازگشت ثبت شده.
