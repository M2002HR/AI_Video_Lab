...
اجرای قابل‌تکرار STAGE_23 با حفظ evidence و gate روشن.

## ورودی لازم

postmortem و evidence. ورودی اختیاری: feedback کاربر، reference style/scene و constraint ابزار. پیش‌نیاز: stage قبلی approved یا blocker/assumption ثبت‌شده.

## رویه

1. STATUS، SOP/checklist و evidence مرتبط را بخوانید.
2. شواهد را طبقه‌بندی کن؛ فقط learning validated استاندارد را تغییر می‌دهد.
...
OBS/HYP/LRN/CHG. Pass یعنی usable، provenance کامل و معیار stage؛ Fail یعنی blocker/failure و تصمیم repair/regenerate/بازگشت ثبت شده.
