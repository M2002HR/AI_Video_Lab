...
اجرای قابل‌تکرار STAGE_00 با حفظ evidence و gate روشن.

## ورودی لازم

brief و ورودی‌های اصلی. ورودی اختیاری: feedback کاربر، reference style/scene و constraint ابزار. پیش‌نیاز: stage قبلی approved یا blocker/assumption ثبت‌شده.

## رویه

1. STATUS، SOP/checklist و evidence مرتبط را بخوانید.
2. اصل‌ها را بدون تغییر نگه‌دار؛ deliverable، hash، assumption و کمبود را ثبت کن.
...
project.json، STATUS و inventory. Pass یعنی usable، provenance کامل و معیار stage؛ Fail یعنی blocker/failure و تصمیم repair/regenerate/بازگشت ثبت شده.
