...
اجرای قابل‌تکرار STAGE_12 با حفظ evidence و gate روشن.

## ورودی لازم

storyboard و identity lock. ورودی اختیاری: feedback کاربر، reference style/scene و constraint ابزار. پیش‌نیاز: stage قبلی approved یا blocker/assumption ثبت‌شده.

## رویه

1. STATUS، SOP/checklist و evidence مرتبط را بخوانید.
2. فقط keyframeهای کنترل‌کننده را تولید و provenance کامل ثبت کن.
...
keyframe Runها. Pass یعنی usable، provenance کامل و معیار stage؛ Fail یعنی blocker/failure و تصمیم repair/regenerate/بازگشت ثبت شده.
