...
اجرای قابل‌تکرار STAGE_06 با حفظ evidence و gate روشن.

## ورودی لازم

brief و رفرنس approved. ورودی اختیاری: feedback کاربر، reference style/scene و constraint ابزار. پیش‌نیاز: stage قبلی approved یا blocker/assumption ثبت‌شده.

## رویه

1. STATUS، SOP/checklist و evidence مرتبط را بخوانید.
2. campaign، emotion، realism، scale، camera، lighting و product priority را ثبت کن.
...
creative direction. Pass یعنی usable، provenance کامل و معیار stage؛ Fail یعنی blocker/failure و تصمیم repair/regenerate/بازگشت ثبت شده.
