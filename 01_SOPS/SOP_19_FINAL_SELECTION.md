...
اجرای قابل‌تکرار STAGE_19 با حفظ evidence و gate روشن.

## ورودی لازم

evaluated runs. ورودی اختیاری: feedback کاربر، reference style/scene و constraint ابزار. پیش‌نیاز: stage قبلی approved یا blocker/assumption ثبت‌شده.

## رویه

1. STATUS، SOP/checklist و evidence مرتبط را بخوانید.
2. با rubric و brief، انتخاب و دلیل را ثبت کن؛ final بدون evaluation ممنوع.
...
selected final run. Pass یعنی usable، provenance کامل و معیار stage؛ Fail یعنی blocker/failure و تصمیم repair/regenerate/بازگشت ثبت شده.
