...
اجرای قابل‌تکرار STAGE_13 با حفظ evidence و gate روشن.

## ورودی لازم

keyframe و اصل. ورودی اختیاری: feedback کاربر، reference style/scene و constraint ابزار. پیش‌نیاز: stage قبلی approved یا blocker/assumption ثبت‌شده.

## رویه

1. STATUS، SOP/checklist و evidence مرتبط را بخوانید.
2. identity، scale، light، scene و character continuity را بررسی کن.
...
approved keyframe set. Pass یعنی usable، provenance کامل و معیار stage؛ Fail یعنی blocker/failure و تصمیم repair/regenerate/بازگشت ثبت شده.
