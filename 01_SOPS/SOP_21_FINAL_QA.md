...
اجرای قابل‌تکرار STAGE_21 با حفظ evidence و gate روشن.

## ورودی لازم

deliverable. ورودی اختیاری: feedback کاربر، reference style/scene و constraint ابزار. پیش‌نیاز: stage قبلی approved یا blocker/assumption ثبت‌شده.

## رویه

1. STATUS، SOP/checklist و evidence مرتبط را بخوانید.
2. brief، format، brand، logo، audio و commercial readiness را تأیید کن.
...
final QA report. Pass یعنی usable، provenance کامل و معیار stage؛ Fail یعنی blocker/failure و تصمیم repair/regenerate/بازگشت ثبت شده.
