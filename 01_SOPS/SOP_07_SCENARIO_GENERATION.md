...
اجرای قابل‌تکرار STAGE_07 با حفظ evidence و gate روشن.

## ورودی لازم

creative direction. ورودی اختیاری: feedback کاربر، reference style/scene و constraint ابزار. پیش‌نیاز: stage قبلی approved یا blocker/assumption ثبت‌شده.

## رویه

1. STATUS، SOP/checklist و evidence مرتبط را بخوانید.
2. timeline ده‌ثانیه‌ای، ریسک، capability و reference لازم هر سناریو را بنویس.
...
candidate scenarios. Pass یعنی usable، provenance کامل و معیار stage؛ Fail یعنی blocker/failure و تصمیم repair/regenerate/بازگشت ثبت شده.
