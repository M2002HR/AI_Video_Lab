...
اجرای قابل‌تکرار STAGE_10 با حفظ evidence و gate روشن.

## ورودی لازم

shot design. ورودی اختیاری: feedback کاربر، reference style/scene و constraint ابزار. پیش‌نیاز: stage قبلی approved یا blocker/assumption ثبت‌شده.

## رویه

1. STATUS، SOP/checklist و evidence مرتبط را بخوانید.
2. برای هر beat composition، subject، action و transition را مشخص کن.
...
storyboard specification. Pass یعنی usable، provenance کامل و معیار stage؛ Fail یعنی blocker/failure و تصمیم repair/regenerate/بازگشت ثبت شده.
