# SOP 03 REFERENCE STRATEGY

## هدف

اجرای قابل‌تکرار STAGE_03 با حفظ evidence و gate روشن.

## ورودی لازم

identity spec و هدف. ورودی اختیاری: feedback کاربر، reference style/scene و constraint ابزار. پیش‌نیاز: stage قبلی approved یا blocker/assumption ثبت‌شده.

## رویه

1. STATUS، SOP/checklist و evidence مرتبط را بخوانید.
2. نیاز cleanup/angle/macro/scene را تعیین و identity را از style جدا کن.
...
reference plan و roleها. Pass یعنی usable، provenance کامل و معیار stage؛ Fail یعنی blocker/failure و تصمیم repair/regenerate/بازگشت ثبت شده.
