...
اجرای قابل‌تکرار STAGE_18 با حفظ evidence و gate روشن.

## ورودی لازم

QA و failure tags. ورودی اختیاری: feedback کاربر، reference style/scene و constraint ابزار. پیش‌نیاز: stage قبلی approved یا blocker/assumption ثبت‌شده.

## رویه

1. STATUS، SOP/checklist و evidence مرتبط را بخوانید.
2. local cosmetic را repair و identity/structure/continuity را regenerate یا stage قبلی کن.
...
repair/regenerate decision. Pass یعنی usable، provenance کامل و معیار stage؛ Fail یعنی blocker/failure و تصمیم repair/regenerate/بازگشت ثبت شده.
