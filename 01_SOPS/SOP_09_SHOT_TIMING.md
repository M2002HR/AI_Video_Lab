...
اجرای قابل‌تکرار STAGE_09 با حفظ evidence و gate روشن.

## ورودی لازم

سناریو منتخب. ورودی اختیاری: feedback کاربر، reference style/scene و constraint ابزار. پیش‌نیاز: stage قبلی approved یا blocker/assumption ثبت‌شده.

## رویه

1. STATUS، SOP/checklist و evidence مرتبط را بخوانید.
2. beat، framing، حرکت، contact، final hero و SFX را sequence کن.
...
timeline، camera plan، continuity. Pass یعنی usable، provenance کامل و معیار stage؛ Fail یعنی blocker/failure و تصمیم repair/regenerate/بازگشت ثبت شده.
