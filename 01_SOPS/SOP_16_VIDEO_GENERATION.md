...
اجرای قابل‌تکرار STAGE_16 با حفظ evidence و gate روشن.

## ورودی لازم

package و settings. ورودی اختیاری: feedback کاربر، reference style/scene و constraint ابزار. پیش‌نیاز: stage قبلی approved یا blocker/assumption ثبت‌شده.

## رویه

1. STATUS، SOP/checklist و evidence مرتبط را بخوانید.
2. هر generation را با tool/model/settings/outputs کامل ثبت کن.
...
video Runها. Pass یعنی usable، provenance کامل و معیار stage؛ Fail یعنی blocker/failure و تصمیم repair/regenerate/بازگشت ثبت شده.
